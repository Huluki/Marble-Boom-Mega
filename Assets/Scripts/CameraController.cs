...
public class CameraController : MonoBehaviour
{
    ...
    public Transform pivotTransformBackup;
    
    // camera sensitivity
    public static float orbitSpeed;
    public static float followSpeed = 5f;
    ...
    static public bool shouldLook = true;
    ...
    void Update()
    {
        if (shouldLook)
        {
            ...
            HandleCameraRotation(Time.unscaledDeltaTime);
    ...
    public void pivot()
    {
        pivotTransform= pivotTransformBackup;
    }
